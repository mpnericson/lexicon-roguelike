...
var TIP_DEFS=[
  ...
  {sel:'#live-score-row',name:'Word Score',text:'How many points the tiles you\'ve placed are currently worth (letters × multiplier).'},
  {sel:'#stat-score-box',name:'Round Progress',text:'Points scored this round versus the target. Reach the target to beat the blind and head to the shop.'},
  ...
  {sel:'#run-info-wrap',name:'Run Info',text:'Your progress through the run — upcoming score targets and constraints — plus every word you\'ve played this run.'},
  ...
  {sel:'#shuffle-btn-wrap',name:'Shuffle',text:'Rearranges the tiles in your hand.'},
  ...
  {sel:'#play-btn-wrap',name:'Play',text:'Submits the tiles you\'ve placed. Every word formed must be valid. Costs one hand.'},
  {sel:'#disc-btn-wrap',name:'Discard',text:'Returns the selected hand tiles to the bag and draws replacements. Costs one discard.'},
