...
var ACHIEVEMENTS = [
  ...
  {id:'stage_1',       name:'Getting Started',  desc:'Complete Board 1.',                           icon:'1️⃣'},
  {id:'stage_2',       name:'Halfway There',    desc:'Complete Board 2.',                           icon:'2️⃣'},
  {id:'win',           name:'Champion',         desc:'Beat all 24 rounds.',                         icon:'🏆'},
